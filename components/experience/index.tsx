...
// Static data lifted outside the component — no reason to recreate this
// object on every render since it never changes at runtime.
...
// Extracted shared card body — previously this entire block was copy-pasted
// verbatim inside both branches of the isContentRight conditional, with the
// only difference being which side EmptySection appeared on.
function ExperienceCardContent({ experience }: { experience: TExperience }) {
  return (
    <ExperienceCard>
      <ExperienceHeaderContent>
